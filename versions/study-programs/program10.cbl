       ...
       01 NOMBRE         PIC X(18).
       01 MENSAJE         PIC X(70).
       01  SALIR-MOSTRAR          PIC X VALUE "N".   
       01 WS-FS          PIC XX.
       ...
       INGRESAR-PERSONAS.
           OPEN EXTEND PERSONAS-FILE   *> Abrimos el archivo en modo EXTEND para agregar registros SOLO ES EN ARCHIVOS SECUENCIALES
           PERFORM UNTIL SALIR-MOSTRAR = "S" OR SALIR-MOSTRAR = "s"
               DISPLAY "PERSONA: "
               ACCEPT NOMBRE
               ...
               ACCEPT SALIR-MOSTRAR
           END-PERFORM
           DISPLAY "DESEA VER LA ISTA DE NUEVO? (S/N): "
           ACCEPT SALIR-MOSTRAR
           IF SALIR-MOSTRAR = "S" OR SALIR-MOSTRAR = "s"
               CLOSE PERSONAS-FILE
               PERFORM LISTAR-PERSONAS
           END-IF.
