       ...
       01 PANTALLA-LISTADO.
           ...
           *> Encabezados de columna
           05 LINE 3 COL 2  VALUE "ID"          HIGHLIGHT.
           05 LINE 3 COL 15 VALUE "NOMBRE"      HIGHLIGHT.
           05 LINE 3 COL 47 VALUE "DIRECCION"   HIGHLIGHT.
           05 LINE 3 COL 78 VALUE "C"           HIGHLIGHT.
           05 LINE 4 COL 1  PIC X(80) FROM ALL "-".
           
           05 LINE 24 COL 1 PIC X(80) FROM ALL " " BACKGROUND-COLOR 7.
           05 LINE 24 COL 2 VALUE "ESC=Volver" BACKGROUND-COLOR 7 FOREGROUND-COLOR 1.
       ...
       PINTAR-LINEA.
           DISPLAY CLI_ID        LINE WS-FILA COL 2.
           DISPLAY CLI_NOMBRE    LINE WS-FILA COL 15.
           DISPLAY CLI_DIRECCION LINE WS-FILA COL 47.
           DISPLAY CLI_CATEGORIA LINE WS-FILA COL 78.
