      ...
      *> ******************************************************************
       ...
       *>----------------------------------------
       ...
       01 PANTALLA-BASE.
           COPY "HEADER.cpy". 
           05 LINE 03 COL 70 VALUE "PAG:".
           05 LINE 03 COL 75 PIC ZZ9 FROM WS-PAG-ACTUAL.
           05 LINE 05 COL 02  VALUE "FECHA ACT"         BACKGROUND-COLOR 1 FOREGROUND-COLOR 7.
           05 LINE 05 COL 15 VALUE "CODIGO"      BACKGROUND-COLOR 1 FOREGROUND-COLOR 7.
           05 LINE 05 COL 35 VALUE "BODEGA"   BACKGROUND-COLOR 1 FOREGROUND-COLOR 7.
           05 LINE 05 COL 50 VALUE "MAXIMO"   BACKGROUND-COLOR 1 FOREGROUND-COLOR 7.
           05 LINE 05 COL 58 VALUE "MINIMO"   BACKGROUND-COLOR 1 FOREGROUND-COLOR 7.
           05 LINE 05 COL 69 VALUE "CANTIDAD"   BACKGROUND-COLOR 1 FOREGROUND-COLOR 7.
       ...
       MOSTRAR-PANTALLA-ACTUAL.
           PERFORM VARYING WS-INDICE FROM 1 BY 1 
               UNTIL WS-INDICE > 18 *>(WS-FILA-MAX - WS-FILA-INICIO + 1)
       ...
       RECARGAR-PAGINA.
           ...
           *> Lee hasta llenar 20 registros o fin de archivo
           PERFORM UNTIL WS-INDICE > 18 OR FIN-LISTA
