       ...
       01 PANTALLA-BASE.
           ...
           05 LINE 06 COL 04 VALUE "| Codigo Bodega    :" BACKGROUND-COLOR 1.
           05 LINE 06 COL 67 VALUE "|" BACKGROUND-COLOR 1.
           05 LINE 07 COL 04 VALUE "| Nombre Bodega    :" BACKGROUND-COLOR 1.
           05 LINE 07 COL 67 VALUE "|" BACKGROUND-COLOR 1.
           05 LINE 08 COL 04 VALUE "| Estado (A/I)     :" BACKGROUND-COLOR 1.
       ...
       01 FORM-BODEGA.
          05 F-BOD-CODIGO LINE 06 COL 25 PIC 9(04) USING W-BOD-CODIGO.
          05 F-BOD-NOMBRE LINE 07 COL 25 PIC X(30) USING W-BOD-NOMBRE.
          05 F-BOD-ESTADO LINE 08 COL 25 PIC X     USING W-BOD-ESTADO. 
       ...
       EDITAR-DATOS. 
           ACCEPT W-BOD-NOMBRE LINE 07 COL 25 WITH UPDATE PROMPT HIGHLIGHT.
           IF WS-KEY = KEY-ESC EXIT PARAGRAPH.
           ACCEPT W-BOD-ESTADO LINE 08 COL 25 WITH UPDATE PROMPT HIGHLIGHT.
           IF WS-KEY = KEY-ESC EXIT PARAGRAPH.
